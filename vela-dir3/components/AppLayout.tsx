...
export default function AppLayout() {
  ...
  return (
    <div style={{ display: 'flex', height: '100vh', width: '100%', background: 'var(--bg-dark)', overflow: 'hidden' }}>
      ...
      {/* Chat column */}
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', minWidth: 0, borderLeft: '1px solid rgba(255,255,255,0.06)', position: 'relative' }}>
        {/* Top bar */}
        <div style={{
          ...
          <p style={{ fontFamily: 'var(--font-nunito), sans-serif', fontSize: 13, color: 'var(--text-muted)', fontWeight: 400 }}>
